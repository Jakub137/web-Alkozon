...
const mockDict = {
  ...
  customOrderPage: {
    ...
    fields: { base: 'Baza', capacity: 'Poj', strength: 'Moc', flavors: 'Smaki', intensity: 'Intensywność', customName: 'Nazwa', customNamePlaceholder: 'Wpisz', note: 'Notatka', notePlaceholder: 'Wpisz notatkę' },
    flavors: { sweet: 'Słodki', dry: 'Wytrawny', fruity: 'Owocowy', smoky: 'Dymny', herbal: 'Ziołowy', barrel: 'Beczka' },
    validation: { nameHint: 'Podpowiedź', wordsLabel: 'słów' },
    buttons: { back: 'Wstecz', next: 'Dalej', addToCart: 'Dodaj do koszyka', goToSummary: 'Podsumowanie' },
    summary: { title: 'Podsumowanie', base: 'Baza', capacity: 'Poj', strength: 'Moc', intensity: 'Int', flavors: 'Smaki', estimatedPrice: 'Cena' },
