...
export default function NotificationToast({ notification }: { notification: AppNotification }) {
  ...
  const getBgColor = () => {
    switch (notification.type) {
      case "success": return "bg-emerald-50 dark:bg-emerald-950/40 border-emerald-200 dark:border-emerald-800";
      case "info": return "bg-blue-50 dark:bg-blue-950/40 border-blue-200 dark:border-blue-800";
      case "warning": return "bg-amber-50 dark:bg-amber-950/40 border-amber-200 dark:border-amber-800";
      case "error": return "bg-red-50 dark:bg-red-950/40 border-red-200 dark:border-red-800";
    }
  };
